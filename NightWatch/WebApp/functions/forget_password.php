...
$expiresAt = time() + PASSWORD_RESET_TIMEOUT;
$resetCodeHash = nightwatch_code_hash($resetCode);
...
$updateStmt->bind_param("sii", $resetCodeHash, $expiresAt, $user['id']);
...
// ============================================================================
log_security_event(
    "PASSWORD_RESET_REQUESTED | User: {$user['id']} | Email: {$user['email']} | MailSent: " . ($emailSent ? 'YES' : 'NO'),
    'INFO',
    (string) $user['id']
);
