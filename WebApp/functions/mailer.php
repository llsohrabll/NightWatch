...
function send_mail(string $to, string $subject, string $textMessage, string $htmlMessage = ''): bool
{
    ...
    // Tell mail clients this message uses MIME parts.
    ...
    $headerString .= "Content-Type: multipart/alternative; boundary=\"{$boundary}\"; charset=UTF-8\r\n";
    ...
    @file_put_contents($logFile, 
        date('Y-m-d H:i:s') . " | To: {$recipient} | Subject: {$safeSubject} | Success: " . ($success ? 'YES' : 'NO') . "\n",
        FILE_APPEND
    );
